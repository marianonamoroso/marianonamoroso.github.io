...
document.getElementById('btn-skill')
    .addEventListener('click', function(e){
        ...
        let hard = "Cloud Operation, Network Security and Digital Forensics.";
...
.addEventListener('click', function(e){
    ...
    let title = "HashiCorp Certified: Terraform Associate"
    let year = "2021"
...
document.getElementById('btn-certs')
    .addEventListener('click', function(e){
        ...
        let short = "AWS SAA";
        let title = "AWS Solutions Architect - Associate"
        let year = "2021"
